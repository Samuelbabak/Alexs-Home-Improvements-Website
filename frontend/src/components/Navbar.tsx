    ...
    <nav className="bg-navy text-white sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <Link to="/" className="h-[clamp(2.25rem,5vw,3rem)] w-auto shrink-0">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <Link 
              to="/contact" 
              className="bg-gold text-navy px-4 py-2 rounded-md font-bold hover:bg-white transition-all duration-200 whitespace-nowrap"
            >
              Get Free Estimate
            </Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-navy border-t border-navy-700">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link 
              to="/contact" 
              className="block px-3 py-2 rounded-md text-base font-bold bg-gold text-navy text-center mt-4 flex-nowrap"
              onClick={() => setIsOpen(false)}
            >
              Get Free Estimate
            </Link>
